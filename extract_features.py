...
if not os.path.isdir('./rep/'+model_name):
    os.mkdir('./rep/'+model_name)
...
scipy.io.savemat('./rep/'+model_name+'/'+opt.source+"_"+opt.target+'_result_'+opt.query_type+'.mat',result)


#######################################   results with avg for tracklets  ###########################
result = scipy.io.loadmat('./rep/'+model_name+'/'+opt.source+"_"+opt.target+'_result_'+opt.query_type+'.mat')
...
scipy.io.savemat('./rep/'+model_name+'/'+opt.source+"_"+opt.target+'_result_'+opt.query_type+'_s.mat',result)
