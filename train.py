...
parser.add_argument('--train_dir',default='/dataset/moified_dataset',type=str, help='training dir path')
...
image_datasets = {}
image_datasets['train'] = datasets.ImageFolder(os.path.join(train_dir, 'train' + train_all),
